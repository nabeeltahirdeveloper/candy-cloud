    ...
    <div>
      ...
      <div>
        <form onSubmit={handleSubmit(onSubmit)} action="">
          <div className="">
            <div>
              <label htmlFor="user">User Uploads Storage Method</label>
              <br />
              <select
                {...register("uploads->public_driver")}
                onChange={(e) => setMethod(e.target.value)}
                id="user"
                className="h-9 px-2 rounded mt-2 outline-none w-[300px] border"
              >
              ...
              <p className="mt-1 text-xs text-gray-500">
                Where should user private file uploads be stored.
              </p>
            </div>
            <div className="pb-4 mt-6 border-b">
              <label htmlFor="public">Public Uploads Storage Method</label>
              <br />
              <select
                {...register("uploads->uploads_driver")}
                onChange={(e) => setMethod(e.target.value)}
                id="public"
                className="h-9 px-2 rounded mt-2 outline-none w-[300px] border"
              >
              ...
              <p className="mt-1 text-xs text-gray-500">
                Where should user public uploads (like avatars) be stored.
              </p>
            </div>
